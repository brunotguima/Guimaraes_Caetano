            ...
            <nav>
                <div class="row">
                    <div class="nav-wrapper">
                        <div class="col s4">
                            <a href="{{ url('/') }}" class="brand-logo">EmiaFeels - Cinema</a>
                        </div>
                        <div class="col s4">
                            <div class="nav-content justify">
                                <ul class="tabs tabs-transparent">
                                    <li class="tab"><a href="{{ url('/generos/') }}">Generos</a></li>
                        ...
                        <ul id="nav-mobile" class="ag hide-on-med-and-down">
                            @if (Auth::guest())
                            <div class="col s4">
                                <li class="right"><a class="waves-effect waves-light btn right" href="{{ route('login') }}">Login</a></li>
                                <li class="right"><a class="waves-effect waves-teal btn-flat right" href="{{ route('register') }}">Registrar</a></li>
                            </div>
                            @else
                            <div class="col s4">
                                <div> 
